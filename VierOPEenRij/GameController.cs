...
namespace HenE.VierOPEenRij
{
    ...
    public class GameController
    {
        ...
        private readonly GameVierOpEenRij gameVierOpEenRij = null;
        ...
        public GameController(SpeelVlak speelVlak, int dimension, GameVierOpEenRij gameVierOpEenRij)
        {
        ...
        {
            this.speelVlak.ResetSpeelVlak(this.dimension);
